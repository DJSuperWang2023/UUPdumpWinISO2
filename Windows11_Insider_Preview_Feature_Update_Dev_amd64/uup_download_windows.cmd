@echo off
:: Generated on 2026-09-09 01:02:32 GMT
...
:START_PROCESS
title 26340.9354_amd64_zh-cn_multi_f79e9e51 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f79e9e51-35df-4d29-8ba2-e917ee87e10a&pack=zh-cn&edition=core%%3Bcorecountryspecific%%3Bprofessional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
