@echo off
:: rem 生成时间 2026-09-12 00:00:18 GMT
:: 代理配置
...
:START_PROCESS
title 26340.9482_amd64_zh-cn_multi_a13c52d6 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.cn/get.php?id=a13c52d6-1b15-419a-a33e-36287bd44639&pack=zh-cn&edition=professional;corecountryspecific;core&aria2=2&expires=1789344018&token=37037384d7ba979bc1e728a729bde4fc0f342b4dc9123e2dbaaee82d327b95af"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
