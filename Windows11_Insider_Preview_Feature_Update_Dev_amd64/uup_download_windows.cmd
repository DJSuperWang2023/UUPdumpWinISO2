@echo off
:: Generated on 2026-09-08 01:16:46 GMT
...
:START_PROCESS
title 26340.9233_amd64_zh-cn_multi_ddaefaf4 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=ddaefaf4-7678-4b18-b3b8-36daa7993aec&pack=zh-cn&edition=core%%3Bcorecountryspecific%%3Bprofessional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
